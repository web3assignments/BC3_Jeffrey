...
export default class Match extends Component {
    ...
    async getMapTemp() {
        ...
        let getGas = await contract.methods.getTemp().estimateGas({ from:"0xB74a342b3b96909247e0E138C2886a347E241255"})
        .then(result => {return result})
        .catch(err => console.log(err));        

        let getTemp = await contract.methods.getTemp().send({ from:"0xB74a342b3b96909247e0E138C2886a347E241255", gas:getGas + 10000})
        .then(result => {return result})
        .catch(err => console.log(err));
        console.log(getTemp);
        ...
        .then(result => {return result})
        .catch(err => console.log(err));
        console.log(getResult + " temparature");
    }
    ...
    async beginFight(){
        ...
        let query = await contract.methods.getRandom(5).send({from:accounts[0]});
        console.log(query);
